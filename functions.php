...
function liberty_scripts() {
	...
	wp_enqueue_script( 'liberty-script', get_template_directory_uri() . '/js/main.js', array(), '1.0', true );

	$adminbar = is_admin_bar_showing();
	wp_localize_script( 'liberty-script', 'libertyadminbar', array( $adminbar ) );

	wp_enqueue_script( 'liberty-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '1.0', true );

	wp_enqueue_script( 'liberty-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '1.0', true );
